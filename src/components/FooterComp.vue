      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          ...
          <h6 class="text-uppercase fw-bold mb-4">
            <i class="fas fa-gem me-3"></i>SportWearFlex
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="#!" class="text-reset">Shorts</a>
          </p>
          <p>
            <a href="#!" class="text-reset">T-Shits</a>
          </p>
        </div>
        <!-- Grid column -->
...
<style scoped>
footer{
  background-color: rgba(7, 17, 32, 1);
  color: white;
}
a.text-reset{
